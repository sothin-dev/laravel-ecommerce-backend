...
class TestDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $products = [];
        $productNames = [
            ['name' => 'Wireless Headphones',     'sku' => 'WH-001', 'price' => 79.99,  'sale_price' => 59.99],
            ['name' => 'Bluetooth Speaker',       'sku' => 'BS-002', 'price' => 49.99,  'sale_price' => null],
            ['name' => 'USB-C Hub 7-in-1',        'sku' => 'UC-003', 'price' => 34.99,  'sale_price' => 24.99],
            ['name' => 'Mechanical Keyboard',     'sku' => 'MK-004', 'price' => 119.99, 'sale_price' => null],
            ['name' => 'Cotton T-Shirt',          'sku' => 'CT-005', 'price' => 24.99,  'sale_price' => 19.99],
            ['name' => 'Denim Jacket',            'sku' => 'DJ-006', 'price' => 89.99,  'sale_price' => null],
            ['name' => 'Running Shoes',           'sku' => 'RS-007', 'price' => 129.99, 'sale_price' => 99.99],
            ['name' => 'Yoga Mat',                'sku' => 'YM-008', 'price' => 29.99,  'sale_price' => null],
            ['name' => 'Indoor Plant Pot',        'sku' => 'IP-009', 'price' => 39.99,  'sale_price' => null],
            ['name' => 'LED Desk Lamp',           'sku' => 'LL-010', 'price' => 44.99,  'sale_price' => 34.99],
            ['name' => 'Leather Wallet',          'sku' => 'LW-011', 'price' => 54.99,  'sale_price' => null],
            ['name' => 'Backpack 40L',            'sku' => 'BP-012', 'price' => 69.99,  'sale_price' => 49.99],
            ['name' => 'Stainless Water Bottle',  'sku' => 'WB-013', 'price' => 19.99,  'sale_price' => null],
            ['name' => 'Sunglasses Aviator',      'sku' => 'SG-014', 'price' => 149.99, 'sale_price' => 99.99],
            ['name' => 'Wireless Mouse',          'sku' => 'WM-015', 'price' => 39.99,  'sale_price' => 29.99],
            ['name' => 'HDMI Cable 6ft',          'sku' => 'HC-016', 'price' => 12.99,  'sale_price' => null],
            ['name' => 'Power Bank 20000mAh',     'sku' => 'PB-017', 'price' => 45.99,  'sale_price' => null],
            ['name' => 'Notebook Set',            'sku' => 'NB-018', 'price' => 14.99,  'sale_price' => 9.99],
            ['name' => 'Desk Organizer',          'sku' => 'DO-019', 'price' => 22.99,  'sale_price' => null],
            ['name' => 'Wall Clock Modern',       'sku' => 'WC-020', 'price' => 32.99,  'sale_price' => null],
            ['name' => 'Coffee Mug 400ml',        'sku' => 'CM-021', 'price' => 15.99,  'sale_price' => 11.99],
            ['name' => 'Smart LED Bulb',          'sku' => 'LB-022', 'price' => 18.99,  'sale_price' => null],
            ['name' => 'Fitness Tracker',         'sku' => 'FT-023', 'price' => 89.99,  'sale_price' => 69.99],
            ['name' => 'Portable Charger',        'sku' => 'PC-024', 'price' => 29.99,  'sale_price' => null],
            ['name' => 'Canvas Sneakers',         'sku' => 'CS-025', 'price' => 59.99,  'sale_price' => 44.99],
        ];
