    ...
    <div class="bg-white w-full max-w-2xl rounded-2xl shadow-xl max-h-[90vh] overflow-y-auto">
        <div class="flex items-center justify-between px-8 py-6 border-b">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Define a discount code for your customers.</p>
            </div>
            <a href="{{ route('coupons.index') }}" class="text-3xl text-gray-400 hover:text-red-500">&times;</a>
        </div>

        <form action="{{ route('coupons.store') }}" method="POST" class="p-8 space-y-6">
            @csrf

            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    <label class="block mb-2 font-medium text-gray-700">Coupon Code</label>
                    <input type="text" name="code" value="{{ old('code') }}" placeholder="SUMMER25"
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="value" value="{{ old('value') }}" placeholder="10"
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="min_order_amount" value="{{ old('min_order_amount', 0) }}" placeholder="0"
                        class="w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="max_discount" value="{{ old('max_discount') }}" placeholder="Optional"
                        class="w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <input type="number" name="usage_limit" value="{{ old('usage_limit') }}" placeholder="Unlimited"
                        class="w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500">
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                    ...
                    placeholder="Optional internal note">{{ old('description') }}</textarea>
            </div>

            <div class="flex items-center gap-3">
                <input type="checkbox" name="is_active" value="1" {{ old('is_active', 1) ? 'checked' : '' }} class="w-5 h-5">
